...
var EventCenter = {
  ...
  var Footer = {
    init: function(){
      ...
      this.$leftBtn = this.$footer.find('.icon-arrow-left')
      this.$rightBtn = this.$footer.find('.icon-arrow-right-copy')
      this.isToEnd = false
      this.isToStart = true
  ...
  var App = {
    ...
    bind: function(){
      ...
      this.$container.find('.icon-bofang').on('click', function(){
        if($(this).hasClass('icon-stop')){
          $(this).removeClass('icon-stop').addClass('icon-bofang')
          _this.audio.pause()
        }else{
          $(this).removeClass('icon-bofang').addClass('icon-stop')
          _this.audio.play()
        }
      })
  
      this.$container.find('.icon-xiayishou').on('click', function(){
        _this.loadSong()
      })
      ...
      this.$container.find('icon-shoucang').on('click', function(){
        var $btn = $(this)
    ...
    play: function(song){
      ...
      this.$container.find('.icon-bofang').removeClass('icon-bofang').addClass('icon-stop')
